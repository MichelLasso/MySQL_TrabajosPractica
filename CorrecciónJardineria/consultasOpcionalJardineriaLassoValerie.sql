...
create table pago(
	...
	id_transaccion varchar(40) not null primary key,
...
-- 15. Devuelve un listado con todos los clientes que sean de la ciudad de Madrid y cuyo representante de ventas tenga el código de empleado 11 o 30.
 ...
 -- consultas multitabla (Composición interna) (OPCIONAL) INNER JOIN y NATURAL JOIN.

 -- 1. Obtén un listado con el nombre de cada cliente y el nombre y apellido de su representante de ventas.
 select nombre_cliente,nombre,apellido1, apellido2 from cliente inner join empleado  on cliente.codigo_empleado= cliente.codigo_empleado;

 -- 2. Muestra el nombre de los clientes que hayan realizado pagos junto con el nombre de sus representantes de ventas
 select nombre_cliente,nombre from  pago inner join cliente on pago.codigo_cliente=cliente.codigo_cliente inner join empleado on cliente.codigo_empleado= empleado.codigo_empleado;
 ...
 select cliente.nombre_cliente,empleado.nombre as Representante, empleado.apellido1 as Apellido_Representante, oficina.ciudad as ciudad_oficina from  pago inner join cliente on pago.codigo_cliente=cliente.codigo_cliente inner join empleado on cliente.codigo_empleado= empleado.codigo_empleado inner join oficina on empleado.codigo_oficina = oficina.codigo_oficina;
 
 -- 4. Lista la dirección de las oficinas que tengan clientes en Fuenlabrada
 select cliente.nombre_cliente,empleado.nombre,empleado.apellido1, empleado.apellido2,ofi.ciudad as ciudad_oficina from cliente inner join empleado on cliente.codigo_empleado_rep_ventas= empleado.codigo_empleado inner join oficina on empleado.codigo_oficina = oficina.codigo_oficina where cliente.ciudad='Fuenlabrada';
 ...
 select cliente.nombre_cliente,empleado.nombre as Nombre_empleado,empleado.apellido1 as Apellido_Empleado,oficina.ciudad as ciudad_oficina from cliente inner join empleado on cliente.codigo_empleado= empleado.codigo_empleado inner join oficina on empleado.codigo_oficina = oficina.codigo_oficina;
 ...
 select nombre_cliente, fecha_esperada, fecha_entrega from cliente inner join pedido on cliente.codigo_cliente=pedido.codigo_cliente where fecha_esperada > fecha_entrega;
 
-- 8. Devuelve un listado con el nombre de los empleados junto con el nombre de sus jefes.
select  empleado.nombre as nombre_empleado, empleado.nombre as nombre_jefe  from empleado tablaEmpleado inner join empleado on tablaEmpleado.codigo_empleado=empleado.codigo_jefe;
